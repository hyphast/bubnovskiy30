...
const NavbarProfileInfo = ({photoUrl, firstName, lastName, patronymic, gender, phoneNumber}) => {
  ...
  return (
    <>
      ...
      <div className={NavbarProfileInfoStyles.info}>
        <span className={NavbarProfileInfoStyles.name}>{`${lastName} ${firstName.slice(0, 1)}.${patronymic.slice(0, 1)}.`}</span>
